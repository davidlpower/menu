...
//Load the music posts 3
    ...
    public function action_contact() {
        ...
        $this->template->content = "$body.<p>If you would like to get in contact please send me an e-mail. </p><center><br /><br /><br /> e: <a href='mailto:david@karujahundu.com?Subject=contact'> David</a> | ". $linkedIn . "</center>";
    }
