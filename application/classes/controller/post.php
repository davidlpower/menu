...
//Load the music posts 3
    ...
    public function action_contact() {
        ...
        $this->template->content = "<center><br />Why not send me an e-mail, I'd love to hear from you. <br /><br /> e: <a href='mailto:david@karujahundu.com?Subject=contact'> David</a></center>" . $linkedIn;
    }
